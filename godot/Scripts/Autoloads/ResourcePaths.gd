...
const PERSPECTIVE_TILT_MASK_SHADER: String = "res://Resources/shaders/masks/perspective_tilt_mask.gdshader"
const ALL_SPRITE_MASK_SHADER: String = "res://Resources/shaders/masks/all_sprite_mask.gdshader"

const SNOW_PARTICLE_SHADER: String = "res://Resources/shaders/particles/snow_particle_shader.gdshader"
const UMBRAL_SHADER: String = "res://Resources/shaders/masks/umbral_zone.gdshader"
const DITHER_SHADER: String = "res://Resources/shaders/masks/dither_zone.gdshader"

const SCANLINE_SHADER: String = "res://Resources/shaders/masks/scanline.gdshader"
const FREE_ALPHA_CHANNEL: String = "res://Resources/shaders/masks/free_alpha_channel.gdshader"
const COLLISION_MASK_FRAGMENT_SHADER: String = "res://Resources/shaders/masks/collision_mask_fragment.gdshader"
