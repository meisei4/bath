...
func _process(delta: float) -> void:
    ...
    caustic_material.set_shader_parameter("iTime", iTime)
    caustic_material.set_shader_parameter("iMouse", iMouse)
