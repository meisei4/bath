...
var sfx_list: Array[String] = [
    ResourcePaths.SFX_534_OCARINA,
    ResourcePaths.SFX_114_CLASSIC_PUZZLE_SOUND,
    ResourcePaths.SFX_115_ECHOY,
    ResourcePaths.SFX_127_JUSTGOODSOUND,
    ResourcePaths.SFX_137_INDUSTRIAL,
    ResourcePaths.SFX_246_SHWA,
    ResourcePaths.SFX_247_SHWA,
    ResourcePaths.SFX_133_ECHOY,
    ResourcePaths.SFX_249_ALIEN_DOLPHIN,
    ResourcePaths.SFX_413_ALIEN_DOLPHIN_1,
    ResourcePaths.SFX_428_ALIEN_DOLPHIN_3,
    ResourcePaths.SFX_451_COOL_DOLPHIN_TRICK,
    ResourcePaths.SFX_326_SAD_ALIEN_DEPRESS,
    ResourcePaths.SFX_431_PAINFUL_DOLPHIN,
    ResourcePaths.SFX_477_DOLPHIN,
    ResourcePaths.SFX_256_BAD_SOUND_BZZ,
    ResourcePaths.SFX_259_FUTURISTIC,
    ResourcePaths.SFX_405_FUTURUEY,
    ResourcePaths.SFX_343_ECHOY,
    ResourcePaths.SFX_322_ECHOY,
    ResourcePaths.SFX_261_SCARY_BELL,
    ResourcePaths.SFX_425_ECHOY,
    ResourcePaths.SFX_452_AIRPLANE_LIFT_OFF_UFO,
    ResourcePaths.SFX_454_ALIEN,
    ResourcePaths.SFX_305_BARREL_WOODEN,
    ResourcePaths.SFX_365_CRASH_WITH_BUZZ,
    ResourcePaths.SFX_353_BUBBLY_GROSS_THICK_WATER,
    ResourcePaths.SFX_379_BUBBLY_GROSS,
    ResourcePaths.SFX_380_BUBBLY_GROSS_2,
    ResourcePaths.SFX_383_GOOEY,
    ResourcePaths.SFX_433_SCARY_BLACKNESS_PORTAL,
    ResourcePaths.SFX_462_BUBBLY,
    ResourcePaths.SFX_466_FUTURISTIC_BUBBLY,
    ResourcePaths.SFX_469_SPLASH,
    ResourcePaths.SFX_391_FOOTSTEPS_RUNNING_AWAY,
    ResourcePaths.SFX_266_SOME_SOUND,
    ResourcePaths.SFX_377_SNOWY_SHWA,
    ResourcePaths.SFX_541_BWUOO,
    ResourcePaths.SFX_542_BWOUAAA,
    ResourcePaths.SFX_544_METAL_ICE_SHARD,
    ResourcePaths.SFX_545_METAL_ICE_SHARD_DUPLICATE,
    ResourcePaths.SFX_135_BUBBLY_DOWNFALL_DROWN
]
...
func _on_button_play_pressed() -> void:
    ...
    if sfx_path:
        ...
        if sfx_res:
            ...
            _update_active_sounds(sfx_path, "ResourcePaths.SFX")
