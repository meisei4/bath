...
pub fn build_silhouette_radii1(silhouette_img: &Image) -> Vec<f32> {
    ...
    let pixel_bytes = unsafe { from_raw_parts(silhouette_img.data as *const u8, total_bytes) };
...
pub fn generate_silhouette_texture1(
