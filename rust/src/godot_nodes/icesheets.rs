...
use asset_payload::{FREE_ALPHA_CHANNEL_GDSHADER_PATH_GD, ICE_SHEETS_GDSHADER_PATH_GD};
...
impl INode2D for IceSheetsRenderer {
    ...
    fn ready(&mut self) {
        ...
        let mut buffer_a_shader = render.load_shader_fragment(ICE_SHEETS_GDSHADER_PATH_GD);
        ...
        let mut buffer_b_shader = render.load_shader_fragment(FREE_ALPHA_CHANNEL_GDSHADER_PATH_GD);
