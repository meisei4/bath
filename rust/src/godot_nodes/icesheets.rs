...
impl INode2D for IceSheetsRenderer {
    ...
    fn ready(&mut self) {
        ...
        let mut buffer_a_shader = render.load_shader_fragment(ResourcePaths::ICE_SHEETS_GDSHADER);
        ...
        let mut buffer_b_shader = render.load_shader_fragment(ResourcePaths::FREE_ALPHA_CHANNEL_GDSHADER);
