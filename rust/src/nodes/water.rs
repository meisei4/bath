...
impl INode2D for WaterProjectedRenderer {
    ...
    fn ready(&mut self) {
        ...
        let mut buffer_a_shader = render.load_shader_fragment(ResourcePaths::FINITE_APPROX_RIPPLE);
        ...
        let mut buffer_b_shader = render.load_shader_fragment(ResourcePaths::WATER_PROJECTED_SHADER);
